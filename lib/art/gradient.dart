...
class GradientArt extends StatefulWidget {
  GradientArt({Key? key}) : super(key: key);
  static const routeName = '/gradient';
  @override
  State<GradientArt> createState() => _GradientArtState();
}

class _GradientArtState extends State<GradientArt> {
  int _counter = 0;
        ...
        child: Scaffold(
          ...
          body: Center(
            child: Column(
              ...
              children: <Widget>[
                const Text(
                  'Drag the Pointer to change the Gradient',
                ),
                Text(
                  '$_counter',
...
class BackgroundWidget extends StatefulWidget {
  ...
  const BackgroundWidget(
      {super.key, required this.child, required this.pointerPosition});
...
class _BackgroundWidgetState extends State<BackgroundWidget>
  ...
  double distanceFromBottom() {
    return widget.pointerPosition.dy / size.height;
  }

  @override
  void didUpdateWidget(covariant BackgroundWidget oldWidget) {
    if (oldWidget.pointerPosition != widget.pointerPosition) {
      _animation = Animation.fromValueListenable(
          AlwaysStoppedAnimation(distanceFromBottom()));
    }
